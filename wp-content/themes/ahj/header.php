...
<head>
    ...
    <script async src="https://www.googletagmanager.com/gtag/js?id=G-TGKGDDTRZJ"></script>
    <script>
...
<body>
    <header>
        ...
        <div class="logo <?php if (is_page('home')) echo "logo--white-angle"; ?> <?php if (!is_page('home')) echo "logo--white-angle-no-opacity"; ?>">
            <a href="<?php echo bloginfo('wpurl'); ?>" class="logo__link">
                <img src="<?php echo get_template_directory_uri(); ?>/assets/img/logo_ahj.png" alt="Logo AHJ" class="logo__img" />
            </a>
        </div>
        <?php if (is_page('home')) : ?>
            <div id="Slider" class="slider">
                <?php if (have_rows('slide_1') && get_field('slide_1')['imagen']) : ?>
                    <?php while (have_rows('slide_1')) : the_row(); ?>
                        <div class="slider__item slider__item--animated">
                            <img src="<?php the_sub_field('imagen'); ?>" alt="<?php the_sub_field('titulo'); ?>" class="slider__img">
                            <div class="slider__blue-square"></div>
                            <div class="slider__info-left">
                                <h2 class="slider__info-left_h2"><?php the_sub_field('titulo'); ?></h2>
                                <a class="slider__info-left_button" href="<?php the_sub_field('archivo_pdf'); ?>" target="_blank"><?php the_sub_field('texto_boton'); ?></a>
                            </div>
                        </div>
                    <?php endwhile; ?>
                <?php endif; ?>
                ...
                <div class="slider__social-networks">
                    <a href="<?php echo get_option('fb_link'); ?>" target="_blank" class="slider__social-networks-links">
                        <img src="<?php echo get_template_directory_uri(); ?>/assets/img/icons/facebook_blue.png" class="slider__social-networks-links-icons" alt="Facebook">
                    </a>
                    <a href="<?php echo get_option('insta_link'); ?>" target="_blank" class="slider__social-networks-links">
                        <img src="<?php echo get_template_directory_uri(); ?>/assets/img/icons/instagram_blue.png" class="slider__social-networks-links-icons" alt="Instagram">
                    </a>
                    <a href="https://api.whatsapp.com/send?phone=<?php echo get_option('whatsapp_number'); ?>" target="_blank" class="slider__social-networks-links">
                        <img src="<?php echo get_template_directory_uri(); ?>/assets/img/icons/whatsapp_blue.png" class="slider__social-networks-links-icons" alt="Whatsapp">
                    </a>
                </div>
            </div>
        <?php endif; ?>
