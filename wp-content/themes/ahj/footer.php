    ...
    <div class="footer content">
        ...
        <div class="footer__content">
            <span class="footer__content_txt--style">Correo: <br />
                <a href="mailto:<?php echo get_option('correo_ahj'); ?>" class="footer__content_txt--style"><?php echo get_option('correo_ahj'); ?></a>
            </span>
        ...
        <div class="footer__content">
            <a href="<?php echo get_option('fb_link'); ?>" target="_blank" class="footer__content_social_network">
                <img src="<?php echo get_template_directory_uri(); ?>/assets/img/icons/facebook_icon.png" class="footer__content_social_network-img" alt="Facebook">
            </a>
            <a href="<?php echo get_option('insta_link'); ?>" target="_blank" class="footer__content_social_network">
                <img src="<?php echo get_template_directory_uri(); ?>/assets/img/icons/instagram.png" class="footer__content_social_network-img" alt="Instagram">
            </a>
            <a href="https://api.whatsapp.com/send?phone=<?php echo get_option('whatsapp_number'); ?>" target="_blank" class="footer__content_social_network">
                <img src="<?php echo get_template_directory_uri(); ?>/assets/img/icons/whatsapp.png" class="footer__content_social_network-img" alt="Whatsapp">
            </a>
        </div>
    </div>
</footer>
<div class="floating__whatsapp">
    <a href="https://api.whatsapp.com/send?phone=<?php echo get_option('whatsapp_number'); ?>" target="_blank" class="floating__whatsapp_link">
        <img src="<?php echo get_template_directory_uri(); ?>/assets/img/icons/whatsapp_icon.png" alt="Whatsapp AHJ Colombia">
