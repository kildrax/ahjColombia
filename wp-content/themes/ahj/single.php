...
<section class="singlePost content">
    ...
    <div class="singlePost__sideBar">
        ...
        <div class="singlePost__sideBar-share singlePost__sideBar--style">
            ...
            <div class="singlePost__sideBar-share-content">
                <a href="https://www.facebook.com/sharer/sharer.php?u=<?php the_permalink() ?>"
                    class="singlePost__sideBar-share-content-social" target="_blank">
                    <img src="<?php echo get_template_directory_uri(); ?>/assets/img/icons/facebook_post.png"
                        alt="Facebook" class="singlePost__sideBar-share-content-social-icon">
                </a>
            </div>
        </div>
        <?php endwhile; ?>
        <?php endif; ?>
        <div class="singlePost__sideBar-share singlePost__sideBar--style">
            <h4 class="singlePost__sideBar--style-title">¡Contacta con nosotros!</h4>
            <a href="https://www.ahjcolombia.com/contactenos/" class="singlePost__sideBar--style-links">Da clic aquí</a>
        </div>
    </div>
</section>
<?php get_footer(); ?>